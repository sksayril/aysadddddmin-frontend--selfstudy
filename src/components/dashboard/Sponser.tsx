...
function Sponsor() {
  ...
  const fetchSponsors = async () => {
    try {
      const response = await fetch('https://api.notesmarket.in/api/getsponser');
      if (response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        response = await fetch('https://api.notesmarket.in/api/update/sponser', {
          method: 'POST',
          headers: {
        ...
        response = await fetch('https://api.notesmarket.in/api/addsponser', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const handleDelete = async (id) => {
    ...
    try {
      setIsSubmitting(true);
      const response = await fetch('https://api.notesmarket.in/api/delete/sponser', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
